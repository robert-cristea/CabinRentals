...
items[GSTCID('7')].time.start = items[GSTCID('5')].time.end + 10000000;
console.log('GSTCID ', GSTCID('10'));
console.log(`items[GSTCID('5')].time.end`, items[GSTCID('5')].time.end);
...
const config = {
  ...
  plugins: [
    ...
    ItemResizing({
      snapToTime: {
        start({ startTime }) {
          console.log('ItemResizing :>> startTime ', startTime);
          return startTime;
        },
        end({ endTime }) {
          return endTime;
    ...
    ItemMovement({
      snapToTime: {
        start({ startTime }) {
          console.log('ItemMovement :>> startTime ', startTime);
